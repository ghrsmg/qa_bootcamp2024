...
import test.java.petStore.models.Category;
import test.java.petStore.models.Tag;
...
public class PetTest extends BaseTest {
    ...
    public void findPetById(String petId, String responseCode, String name) {
        ...
        MatcherAssert.assertThat(response.getStatusLine(), Matchers.containsStringIgnoringCase("HTTP/1.1"));
